...
#include "AbilityTask_PlayAnimMontageAndWait.generated.h"
 ...
 */
UCLASS()
class GASPROJECT_API UAbilityTask_PlayAnimMontageAndWait : public UAbilityTask
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UAbilityTask_PlayAnimMontageAndWait(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static UAbilityTask_PlayAnimMontageAndWait* PlayMontageAndWaitForEvent(
