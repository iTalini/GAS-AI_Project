...
*/
UCLASS()
class GASPROJECT_API UAbilityTask_SuccessFailEvent : public UAbilityTask
{
	...
	static UAbilityTask_SuccessFailEvent* WaitSuccessFailEvent(UGameplayAbility* OwningAbility, FGameplayTag SuccessTag, FGameplayTag FailedTag, AActor* OptionalExternalTarget, bool OnlyTriggerOnce, bool OnlyMatchExact);
