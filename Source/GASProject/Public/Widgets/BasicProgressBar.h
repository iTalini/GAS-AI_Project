 ...
 */
UCLASS()
class GASPROJECT_API UBasicProgressBar : public UUserWidget
{
	GENERATED_BODY()
...
protected:
	...
	TWeakObjectPtr<class AGASProjectCharacter> OwnerCharacter;
...
public:
	...
	void SetOwnerCharacter(class AGASProjectCharacter* NewOwner);
};
